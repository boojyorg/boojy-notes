  ...
  return (
    <div style={{
      ...
      <input
        ...
        placeholder="Find..."
        style={{
          background: BG.surface, border: "none",
          color: TEXT.primary, fontSize: 12,
          fontFamily: "inherit", padding: "4px 8px",
          borderRadius: 4, outline: "none", width: 160,
        }}
      />
      <button onClick={findPrev} title="Previous (Shift+Enter)" style={btnStyle}>
      ...
      <button onClick={findNext} title="Next (Enter)" style={btnStyle}>
        <svg width="10" height="10" viewBox="0 0 10 10" fill="none">
          <path d="M2 3L5 7L8 3" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
      </button>
...
const btnStyle = {
  ...
  color: TEXT.secondary, padding: 4, borderRadius: 4,
