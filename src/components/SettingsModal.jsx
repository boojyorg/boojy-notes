...
export default function SettingsModal({
  ...
  async function handleEmailAuth(mode) {
    ...
    setAuthError(null);
    if (mode === "signup") {
      const { error } = await authActions.signUpWithEmail(
        emailInput,
        passwordInput,
        nameInput.trim(),
      );
          ...
          >
                ...
                <>
                  ...
                  {authMode === "check-email" ? (
                    ...
                    >
                      ...
                      <p style={{ margin: 0, fontSize: 15, fontWeight: 600, color: TEXT.primary }}>
                        Check your inbox
                      </p>
                      <p
                        style={{
                ...
                <div style={{ marginBottom: 32 }}>
                  ...
                  {(user?.user_metadata?.display_name || user?.user_metadata?.full_name) && (
                    ...
                    >
                      ...
                      <span style={{ fontSize: 14, color: TEXT.primary }}>
            ...
            {isDesktop &&
              (() => {
                const displayPath = notesDir
                  ...
                  : "\u2014";
                const truncated =
                  displayPath.length > 32 ? "\u2026" + displayPath.slice(-30) : displayPath;
                return (
                  <div
            ...
            <div ref={(el) => (sectionRefs.current.appearance = el)}>
              ...
              >
                ...
                <div
                  onClick={() => onToggleSpellCheck && onToggleSpellCheck(!spellCheckEnabled)}
                  style={{
                    width: 36,
                    height: 20,
                    borderRadius: 10,
              ...
              {spellCheckEnabled && (
                ...
                >
                  <span style={{ fontSize: 12, color: TEXT.muted }}>Language</span>
                  <select
                    value={(spellCheckLanguages || ["en-US"])[0]}
                    onChange={(e) =>
                      onChangeSpellCheckLanguages && onChangeSpellCheckLanguages([e.target.value])
                    }
                    style={{
                      background: theme.overlay(0.05),
                      border: `1px solid ${theme.overlay(0.08)}`,
              ...
              >
                <span style={{ fontSize: 13, color: TEXT.muted }}>Theme</span>
                <div
                  style={{
                    display: "flex",
                    borderRadius: 6,
              ...
              {themeMode === "auto" && (
                ...
                >
                  <span style={{ fontSize: 12, color: TEXT.muted }}>Auto method</span>
                  <div
                    style={{
                      display: "flex",
                      borderRadius: 6,
              ...
              {themeMode === "auto" && autoMethod === "time" && (
                ...
                >
                  <span style={{ fontSize: 12, color: TEXT.muted }}>Schedule</span>
